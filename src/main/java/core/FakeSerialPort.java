...
public class FakeSerialPort extends SerialPort {
    ...
    private List<SerialPortEventListener> listeners;
    ...
    public void addEventListener(SerialPortEventListener serialPortEventListener) throws TooManyListenersException {
        listeners.add(serialPortEventListener);
    }
    ...
    public void triggerDataAvailable(){
        listeners.forEach(l -> l.serialEvent(new SerialPortEvent(this, SerialPortEvent.DATA_AVAILABLE, true, true)));
    }
}
